// copied from https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/util/ExecUtil.java
...
public class ExecUtil {
     ...
     * @return true if commands where executed successfully
     */
    public static boolean execWithTimeout(Log log, Duration timeout, String command, String... args) {
        return execWithTimeout(log, new File("."), timeout, command, args);
    }
